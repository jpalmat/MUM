...
import lab5problem1.factorymethods.RuleException;
import lab5problem1.factorymethods.RuleSet;
import lab5problem1.factorymethods.RuleSetFactory;
...
public class ProfileWindow extends JFrame {
	...
	private void defineMiddlePanel() {
		...
		JPanel statePanel = createTextPanel(labelFavoriteMovie,
				favoriteMovieField);

		JLabel labelFavoriteRestaurant = new JLabel("Favorite Restaurant");
		labelFavoriteRestaurant.setFont(makeSmallFont(labelFavoriteRestaurant
				.getFont()));
		favoriteRestaurantField = new JTextField(12);
		JPanel zipPanel = createTextPanel(labelFavoriteRestaurant,
				favoriteRestaurantField);
	...
	class ButtonListener implements ActionListener {
		public void actionPerformed(ActionEvent evt) {
			...
			RuleSet profileRules = RuleSetFactory
					.getRuleSet(ProfileWindow.this);
			...
			try {
				...
				String output = name + n + street + n + city + ", " + state
						+ " " + zip;
