...
//			}
//		};
//		System.out.println(LambdaLibrary.QUERY4.apply(testItem4,25,5));
		...
		System.out.println(LambdaLibrary.QUERY5.apply(testItem5, Arrays.asList(3,4,5)));
...
//		System.out.println(LambdaLibrary.QUERY6.apply(testItem6,55000,120000));
//		
//		System.out.println("\nQuery 7");
...
//		System.out.println(LambdaLibrary.QUERY7.apply(testItem7));
//	        
//		System.out.println("\nQuery 8");
//		// Find all traders from Cambridge and sort them by name.
//		List<Transaction> testItem8 = testItem7;  
//		System.out.println(LambdaLibrary.QUERY8.apply(testItem8,"Cambridge"));
