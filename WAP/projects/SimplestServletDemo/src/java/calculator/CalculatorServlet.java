...
public class CalculatorServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Integer totalSum = Integer.valueOf(firstPlus) + Integer.valueOf(secondPlus);
        Integer totalTimes = Integer.valueOf(firstTimes) * Integer.valueOf(secondTimes);
        
        response.setContentType("text/html");
        PrintWriter out = response.getWriter();
        out.println("<br>" + firstPlus +" + " + secondPlus + " = " + totalSum);
        out.println("<br>" + firstTimes +" * " + secondTimes + " = " + totalTimes);
    }
